...
FRAMEWORK_XSD="${NEW_XSD_PATH}/NewsML-G2_${NEW_VERSION}-spec-Framework-Power_${NEWSMLG2_REVISION}.xsd"
# NewsML-G2_2.28-spec-ConceptItem-Power_2.xsd -> NewsML-G2_2.29-spec-ConceptItem-Power_1.xsd
sed -i '' "s/NewsML-G2_${OLD_NEWSMLG2_VERSION}_spec-\\([a-zA-Z]+\\)\-Power_${OLD_NEWSMLG2_REVISION}/NewsML-G2_${NEWSMLG2_VERSION}_spec-\1-Power_${NEWSMLG2_REVISION}/g" $FRAMEWORK_XSD
echo "Done."
