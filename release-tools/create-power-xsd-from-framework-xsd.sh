...
rm -f $COMBINED_XSD_WITH_REVISION  # don't complain if the file doesn't already exist
...
echo "Removing old $OLD_COMBINED_XSD_NO_REVISION"
rm -f $OLD_COMBINED_XSD_NO_REVISION  # don't complain if the file doesn't already exist
